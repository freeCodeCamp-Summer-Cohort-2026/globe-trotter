...
export const ModuleTabs = ({ tabs, activeTab, onChange }: ModuleTabsProps) => (
	<Tabs.Root className="ui:w-full ui:max-w-7xl ui:mx-auto ui:px-4 ui:sm:px-6 ui:md:px-8 ui:lg:px-12 ui:xl:px-0" defaultValue={activeTab} onValueChange={onChange}>
